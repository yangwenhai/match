...
type MatchReplyCapn C.Struct

func NewMatchReplyCapn(s *C.Segment) MatchReplyCapn      { return MatchReplyCapn(s.NewStruct(8, 0)) }
func NewRootMatchReplyCapn(s *C.Segment) MatchReplyCapn  { return MatchReplyCapn(s.NewRootStruct(8, 0)) }
func AutoNewMatchReplyCapn(s *C.Segment) MatchReplyCapn  { return MatchReplyCapn(s.NewStructAR(8, 0)) }
func ReadRootMatchReplyCapn(s *C.Segment) MatchReplyCapn { return MatchReplyCapn(s.Root(0).ToStruct()) }
func (s MatchReplyCapn) RetCode() int8                   { return int8(C.Struct(s).Get8(0)) }
func (s MatchReplyCapn) SetRetCode(v int8)               { C.Struct(s).Set8(0, uint8(v)) }
func (s MatchReplyCapn) WriteJSON(w io.Writer) error {
	b := bufio.NewWriter(w)
	var err error
	var buf []byte
	_ = buf
...
func (s MatchReplyCapn) MarshalJSON() ([]byte, error) {
	b := bytes.Buffer{}
	err := s.WriteJSON(&b)
	return b.Bytes(), err
}
func (s MatchReplyCapn) WriteCapLit(w io.Writer) error {
	b := bufio.NewWriter(w)
	var err error
	var buf []byte
	_ = buf
...
func (s MatchReplyCapn) MarshalCapLit() ([]byte, error) {
	b := bytes.Buffer{}
	err := s.WriteCapLit(&b)
	return b.Bytes(), err
}

type MatchReplyCapn_List C.PointerList

func NewMatchReplyCapnList(s *C.Segment, sz int) MatchReplyCapn_List {
	return MatchReplyCapn_List(s.NewCompositeList(8, 0, sz))
}
func (s MatchReplyCapn_List) Len() int { return C.PointerList(s).Len() }
func (s MatchReplyCapn_List) At(i int) MatchReplyCapn {
	return MatchReplyCapn(C.PointerList(s).At(i).ToStruct())
}
func (s MatchReplyCapn_List) ToArray() []MatchReplyCapn {
	n := s.Len()
	a := make([]MatchReplyCapn, n)
	for i := 0; i < n; i++ {
		a[i] = s.At(i)
	}
	return a
}
func (s MatchReplyCapn_List) Set(i int, item MatchReplyCapn) { C.PointerList(s).Set(i, C.Object(item)) }

type MatchRequestCapn C.Struct

func NewMatchRequestCapn(s *C.Segment) MatchRequestCapn { return MatchRequestCapn(s.NewStruct(24, 2)) }
func NewRootMatchRequestCapn(s *C.Segment) MatchRequestCapn {
	return MatchRequestCapn(s.NewRootStruct(24, 2))
}
func AutoNewMatchRequestCapn(s *C.Segment) MatchRequestCapn {
	return MatchRequestCapn(s.NewStructAR(24, 2))
}
func ReadRootMatchRequestCapn(s *C.Segment) MatchRequestCapn {
	return MatchRequestCapn(s.Root(0).ToStruct())
}
func (s MatchRequestCapn) GameGroup() string      { return C.Struct(s).GetObject(0).ToText() }
func (s MatchRequestCapn) GameGroupBytes() []byte { return C.Struct(s).GetObject(0).ToData() }
func (s MatchRequestCapn) SetGameGroup(v string)  { C.Struct(s).SetObject(0, s.Segment.NewText(v)) }
func (s MatchRequestCapn) GameDb() string         { return C.Struct(s).GetObject(1).ToText() }
func (s MatchRequestCapn) GameDbBytes() []byte    { return C.Struct(s).GetObject(1).ToData() }
func (s MatchRequestCapn) SetGameDb(v string)     { C.Struct(s).SetObject(1, s.Segment.NewText(v)) }
func (s MatchRequestCapn) ServerId() int64        { return int64(C.Struct(s).Get64(0)) }
func (s MatchRequestCapn) SetServerId(v int64)    { C.Struct(s).Set64(0, uint64(v)) }
func (s MatchRequestCapn) UserId() int64          { return int64(C.Struct(s).Get64(8)) }
func (s MatchRequestCapn) SetUserId(v int64)      { C.Struct(s).Set64(8, uint64(v)) }
func (s MatchRequestCapn) Score() int64           { return int64(C.Struct(s).Get64(16)) }
func (s MatchRequestCapn) SetScore(v int64)       { C.Struct(s).Set64(16, uint64(v)) }
func (s MatchRequestCapn) WriteJSON(w io.Writer) error {
	b := bufio.NewWriter(w)
	var err error
	var buf []byte
	_ = buf
...
func (s MatchRequestCapn) MarshalJSON() ([]byte, error) {
	b := bytes.Buffer{}
	err := s.WriteJSON(&b)
	return b.Bytes(), err
}
func (s MatchRequestCapn) WriteCapLit(w io.Writer) error {
	b := bufio.NewWriter(w)
	var err error
	var buf []byte
	_ = buf
...
func (s MatchRequestCapn) MarshalCapLit() ([]byte, error) {
	b := bytes.Buffer{}
	err := s.WriteCapLit(&b)
	return b.Bytes(), err
}

type MatchRequestCapn_List C.PointerList

func NewMatchRequestCapnList(s *C.Segment, sz int) MatchRequestCapn_List {
	return MatchRequestCapn_List(s.NewCompositeList(24, 2, sz))
}
func (s MatchRequestCapn_List) Len() int { return C.PointerList(s).Len() }
func (s MatchRequestCapn_List) At(i int) MatchRequestCapn {
	return MatchRequestCapn(C.PointerList(s).At(i).ToStruct())
}
func (s MatchRequestCapn_List) ToArray() []MatchRequestCapn {
	n := s.Len()
	a := make([]MatchRequestCapn, n)
	for i := 0; i < n; i++ {
		a[i] = s.At(i)
	}
	return a
}
func (s MatchRequestCapn_List) Set(i int, item MatchRequestCapn) {
	C.PointerList(s).Set(i, C.Object(item))
}
